...
class LearningExtension extends \Twig_Extension
{
    ...
    public function getFunctions() {
        return [
            ...
            new \Twig_SimpleFunction('puzzle_learning_posts', [$this, 'getPosts'], ['needs_environment' => false, 'is_safe' => ['html']]),
            new \Twig_SimpleFunction('puzzle_learning_post', [$this, 'getPost'], ['needs_environment' => false, 'is_safe' => ['html']]),
