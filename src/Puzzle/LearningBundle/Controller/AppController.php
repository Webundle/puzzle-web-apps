...
class AppController extends Controller
{
    ...
    public function listPostsAction(Request $request) {
        return $this->render("AppBundle:Learning:list_posts.html.twig", array(
    ...
    public function showPostAction(Request $request, $slug) {
    	return $this->render("AppBundle:Learning:show_post.html.twig", array(
    ...
    public function createCommentAction(Request $request, Post $post) {
        ...
        return $this->redirectToRoute('app_learning_post_show', ['id' => $post->getId()]);
    }
    ...
    public function updateCommentAction(Request $request, Comment $comment) {
        ...
        return $this->redirectToRoute('app_learning_post_show', ['id' => $comment->getPost()->getId()]);
    }
    ...
    public function deleteCommentVoteAction(Request $request, Comment $comment) {
        ...
        return $this->redirectToRoute('app_learning_post_show', ['id' => $postId]);
    }
}
