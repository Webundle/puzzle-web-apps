...
class AdminController extends Controller
{
    ...
    public function listApplicantsAction(Request $request) {
        return $this->render("AdminBundle:Curriculum:list_applicants.html.twig", array(
    ...
    public function createApplicantAction(Request $request){
        ...
        $form = $this->createForm(ApplicantCreateType::class, $applicant, [
            'method' => 'POST',
            'action' => $this->generateUrl('admin_curriculum_applicant_create')
        ]);
        $form->handleRequest($request);
        
        if ($form->isSubmitted() === true && $form->isValid() === true) {
            $data = $request->request->all()['admin_curriculum_applicant_create'];
            ...
            return $this->redirectToRoute('admin_curriculum_applicant_update', ['id' => $applicant->getId()]);
        }
        
        return $this->render("AdminBundle:Curriculum:create_applicant.html.twig", [
    ...
    public function updateApplicantAction(Request $request, Applicant $applicant){
        $form = $this->createForm(ApplicantUpdateType::class, $applicant, [
            'method' => 'POST',
            'action' => $this->generateUrl('admin_curriculum_applicant_update', ['id' => $applicant->getId()])
        ]);
        $form->handleRequest($request);
        
        if ($form->isSubmitted() === true && $form->isValid() === true) {
            $data = $request->request->all()['admin_curriculum_applicant_update'];
        ...
        return $this->render("AdminBundle:Curriculum:update_applicant.html.twig", [
            'applicant' => $applicant,
            'form' => $form->createView()
        ]);
    }
    ...
    public function deleteApplicantAction(Request $request, Applicant $applicant) {
        ...
        return $this->redirectToRoute('admin_curriculum_applicant_list');
    }
    ...
    public function listTrainingsAction(Request $request, Applicant $applicant) {
        ...
        return $this->render("AdminBundle:Curriculum:list_trainings.html.twig", array(
            'applicant' => $applicant,
            'trainings' => $trainings,
        ));
    }
    ...
    public function createTrainingAction(Request $request, Applicant $applicant){
        ...
        $form = $this->createForm(TrainingCreateType::class, $training, [
            'method' => 'POST',
            'action' => $this->generateUrl('admin_curriculum_training_create', ['id' => $applicant->getId()])
        ]);
        $form->handleRequest($request);
        
        if ($form->isSubmitted() === true && $form->isValid() === true) {
            $data = $request->request->all()['admin_curriculum_training_create'];
            ...
            return $this->redirectToRoute('admin_curriculum_training_list', ['id' => $applicant->getId()]);
        }
        
        return $this->render("AdminBundle:Curriculum:create_training.html.twig", [
            'form' => $form->createView(),
        ]);
    }
    ...
    public function updateTrainingAction(Request $request, Training $training){
        $form = $this->createForm(TrainingUpdateType::class, $training, [
            'method' => 'POST',
            'action' => $this->generateUrl('admin_curriculum_training_update', ['id' => $training->getId()])
        ]);
        $form->handleRequest($request);
        ...
        if ($form->isSubmitted() === true && $form->isValid() === true) {
            ...
            return $this->redirectToRoute('admin_curriculum_training_update', ['id' => $training->getId()]);
        }
        
        return $this->render("AdminBundle:Curriculum:update_training.html.twig", [
            'training' => $training,
            'form' => $form->createView(),
        ]);
    }
    ...
    public function deleteTrainingAction(Request $request, Training $training) {
        ...
        $this->addFlash('success', $message);
        return $this->redirectToRoute('admin_curriculum_training_list', ['id' => $training->getApplicant()->getId()]);
    }
    ...
    public function listWorksAction(Request $request, Applicant $applicant) {
        ...
        return $this->render("AdminBundle:Curriculum:list_works.html.twig", array(
            'applicant' => $applicant,
            'works' => $works,
        ));
    }
    ...
    public function createWorkAction(Request $request, Applicant $applicant){
        ...
        $form = $this->createForm(WorkCreateType::class, $work, [
            'method' => 'POST',
            'action' => $this->generateUrl('admin_curriculum_work_create', ['id' => $applicant->getId()])
        ]);
        $form->handleRequest($request);
        
        if ($form->isSubmitted() === true && $form->isValid() === true) {
            $data = $request->request->all()['admin_curriculum_work_create'];
            ...
            return $this->redirectToRoute('admin_curriculum_work_list', ['id' => $applicant->getId()]);
        }
        
        return $this->render("AdminBundle:Curriculum:create_work.html.twig", [
            'form' => $form->createView(),
        ]);
    }
    ...
    public function updateWorkAction(Request $request, Work $work){
        $form = $this->createForm(WorkUpdateType::class, $work, [
            'method' => 'POST',
            'action' => $this->generateUrl('admin_curriculum_work_update', ['id' => $work->getId()])
        ]);
        $form->handleRequest($request);
        
        if ($form->isSubmitted() === true && $form->isValid() === true) {
            $data = $request->request->all()['admin_curriculum_work_update'];
            ...
            $this->addFlash('success', $this->get('translator')->trans('success.post', ['%item%' => $work->getName()], 'messages'));
            return $this->redirectToRoute('admin_curriculum_work_list', ['id' => $work->getApplicant()->getId()]);
        }
